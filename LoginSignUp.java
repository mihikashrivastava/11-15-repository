...
public class LoginSignUp implements LoginSignUpService{
    ...
    public User createNewUser(String username, String password, String email, String firstName, String lastName, String profileImage) throws BadDataException {
        ArrayList<String> accountList = new ArrayList<>();
        ...
        User newUser = new User(username, password, firstName, lastName, email, profileImage);
